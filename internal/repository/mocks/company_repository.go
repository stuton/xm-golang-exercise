...
import (
	...
	model "github.com/stuton/xm-golang-exercise/internal/model"
)
...
func (_m *CompanyRepository) CreateCompany(ctx context.Context, params model.Company) error {
...
// GetCompanyByName provides a mock function with given fields: ctx, name
func (_m *CompanyRepository) GetCompanyByName(ctx context.Context, name string) (*model.Company, error) {
